...
python3 -m EasyLM.models.llama.llama_train \
    ...
    --update_llama_config='' \
    --load_dataset_state='gs://mimir-train-us/llama-control-checkpoint/090ec66984374125bca9f1f490a746ca/dataset.pkl' \
    --load_checkpoint='trainstate::gs://mimir-train-us/llama-control-checkpoint/090ec66984374125bca9f1f490a746ca/streaming_train_state' \
